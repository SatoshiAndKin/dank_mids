#ifndef MYPYC_NATIVE_f5ba6e22fbbacf90552f_H
...
#define MYPYC_DECLARED_tuple_T4OIOC
typedef struct tuple_T4OIOC {
    PyObject *f0;
    CPyTagged f1;
    PyObject *f2;
    char f3;
...
#ifndef MYPYC_DECLARED_tuple_T4OIOO
#define MYPYC_DECLARED_tuple_T4OIOO
typedef struct tuple_T4OIOO {
    PyObject *f0;
    CPyTagged f1;
    PyObject *f2;
    PyObject *f3;
...
typedef struct {
    ...
    CPyVTableItem *vtable;
    CPyTagged _attempts;
    PyObject *_max_attempts;
} dank_mids___helpers____retry_mechanics___RetryBudgetObject;
...
typedef struct {
    ...
    CPyTagged _attempt;
    double _delay;
} dank_mids___helpers____retry_mechanics___RetryDecisionObject;
...
typedef struct {
    ...
    PyObject *___mypyc_generator_attribute__endpoint;
    PyObject *___mypyc_generator_attribute__args;
    PyObject *___mypyc_generator_attribute__loads;
    PyObject *___mypyc_generator_attribute__kwargs;
    PyObject *_type;
    PyObject *_value;
    PyObject *_traceback;
...
typedef struct {
    ...
    CPyVTableItem *vtable;
    PyObject *___mypyc_env__;
} dank_mids___helpers____requester___post_HTTPRequesterThread_genObject;
...
typedef struct {
    ...
    char _disabled;
    PyObject *__cache;
} dank_mids___logging___CLoggerObject;

typedef struct {
    PyObject_HEAD
    CPyVTableItem *vtable;
    int32_t ___mypyc_next_label__;
} dank_mids___logging___use_c_logger_class_genObject;
